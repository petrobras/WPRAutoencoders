...
def main():
    ...
    case_1 = CaseGenerator(tk, k, por, h, ct, Bo, visc, q_ref, skin, L1, L2, L3, L4, rw)
    case_2 = CaseGenerator(tk, k, por, h, ct, Bo, visc, q_ref, 10, L1, L2, L3, L4, rw)
    case_3 = CaseGenerator(tk, k, por, h, ct, Bo, visc, q_ref, -2, L1, L2, L3, L4, rw)
